...
vim.api.nvim_set_keymap("n", "btt", "<cmd>TroubleToggle<cr>", { silent = true, noremap = true })
vim.api.nvim_set_keymap("n", "btw", "<cmd>Trouble workspace_diagnostics<cr>", { silent = true, noremap = true })
